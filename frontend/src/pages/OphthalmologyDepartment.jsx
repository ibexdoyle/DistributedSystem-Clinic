...
import eyeImg from "../assets/khoaMat.jpg";
...
const doctors = [
    {
        id: 1,
        name: "PGS.TS. Trần Văn Sáng",
        position: "Trưởng khoa Mắt",
        experience: "25 năm kinh nghiệm",
        specialty: "Phẫu thuật đục thủy tinh thể, Glocom",
        image: bs1
    },
    {
        id: 2,
        name: "TS.BS. Lê Thị Hồng Nhung",
        position: "Phó khoa Mắt",
        experience: "18 năm kinh nghiệm",
        specialty: "Khúc xạ, Đáy mắt",
        image: bs2
    },
    {
        id: 3,
    ...
    },
    {
        ...
        specialty: "Mắt thẩm mỹ, Phẫu thuật khúc xạ",
        image: bs4
    }
];
                ...
                <>
                    <div style={{ marginBottom: "30px" }}>
                        ...
                        <p style={{
                            ...
                            Khoa Mắt Bệnh viện Đa khoa Quốc tế Vinmec Phú Quốc được trang bị hệ thống máy móc hiện đại, đạt chuẩn quốc tế, cung cấp đầy đủ các dịch vụ chẩn đoán và điều trị các bệnh lý về mắt cho mọi lứa tuổi.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul style={{
                            ...
                            <li style={{ marginBottom: "10px" }}>
                                Điều trị Glocom (bệnh thiên đầu thống)
                            </li>
                            <li style={{ marginBottom: "10px" }}>
                                Phẫu thuật khúc xạ bằng Laser Excimer
                            </li>
                            <li>Điều trị các bệnh lý võng mạc, đáy mắt</li>
                        </ul>
                    </div>
                </>
            );
                        ...
                        <div style={{
                            ...
                            <button
                                ...
                                style={{
                                    padding: "12px 24px",
                                    border: "none",
                                    backgroundColor: activeTab === 'overview' ? "#9c27b0" : "transparent",
                            ...
                            <button
                                ...
                                style={{
                                    padding: "12px 24px",
                                    border: "none",
                                    backgroundColor: activeTab === 'doctors' ? "#9c27b0" : "transparent",
